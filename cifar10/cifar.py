...
num_epochs = 10
num_class = 10
PATH = "./DeepLearning_cifar10"

train_dataset = datasets.CIFAR10(root="dataset/", download=True, train=True, transform=transforms.ToTensor())
train_loader = DataLoader(dataset=train_dataset, batch_size=batch_size, shuffle=True)

test_dataset = datasets.CIFAR10(root="dataset/", download=True, train=False, transform=transforms.ToTensor())
...
def imshow(img):
    ...
    plt.axis('off')
    plt.savefig('lote_cifar10.png')
    print("Imagem salva como 'lote_cifar10.png'")
...
class CNN(nn.Module):
    def __init__(self, in_channels, num_classes):
        ...
        Parameters:
            * in_channels: Number of Channels in the input image (for RBG images, 3)
            * num_classes: Number of classes to predict. In our problem, 10 (i.e digits from 0 to 9).
        """

        super(CNN, self).__init__()

        # Aumentar a quantidade de camadas para treino.
        # Aumentar o out_channels -> 16,32,64,128...
        ...
        self.dropout = nn.Dropout(0.5) # -> Evita overfitting
